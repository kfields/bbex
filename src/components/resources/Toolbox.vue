...
<script>
import ResourcesMixin from 'src/mixins/resources'

export default {
  name: 'ResourcesToolbox',
  ...
  mounted: function () {
    ...
    console.log('ResourcesToolbox mounted')
    console.log(options)
  },
  methods: {
    search () {
